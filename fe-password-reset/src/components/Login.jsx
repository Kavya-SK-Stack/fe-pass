...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-r from-purple-600 to-orange-400">
      <div className="max-w-md mx-auto border-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-5">
          ...
          <input
            ...
            required
          />
          <button type="submit" className="bg-orange-400 text-purple-600 p-2 rounded">
            Login
          </button>
          ...
          <p>
            Forgot password{" "}
            <Link to={"/reset-password"} className="text-orange-600 underline">
              Click here
            </Link>
          </p>
        </form>
